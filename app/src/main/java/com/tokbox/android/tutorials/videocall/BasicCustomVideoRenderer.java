...
import static com.tokbox.android.tutorials.videocall.DeepARRenderer.uv;
...
//    static class DeepARRenderer implements GLSurfaceView.Renderer {
//
...
//
//    /*    public DeepARRenderer(BasicCustomVideoRenderer parent, DeepAR deepAR) {
...
//            }
//
//            surfaceTexture.getTransformMatrix(mScaleMatrix);
//
...
//    }
    ...
    public BasicCustomVideoRenderer(Context context, DeepARRenderer deepARRenderer) {
        this.mContext = context;
        this.mRenderer = deepARRenderer;
        mView = new GLSurfaceView(context);
        mView.setEGLContextClientVersion(2);
        mView.setEGLConfigChooser(8, 8, 8, 8, 16, 0);
        mView.setEGLContextFactory(new com.tokbox.android.tutorials.videocall.DeepARRenderer.MyContextFactory(mRenderer));
